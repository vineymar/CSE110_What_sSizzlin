...
public class CookbookRecyclerViewAdapter extends RecyclerView.Adapter<CookbookRecyclerViewAdapter.ViewHolder> {
    ...
    public CookbookRecyclerViewAdapter(ArrayList<String> names, ArrayList<String> imageUrls, ArrayList<String> times, ArrayList<Recipe> recs, Context context, CookBookFragment hf) {
        this.mNames = names;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.image.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                cookBookFragment.setFragment(nn);
